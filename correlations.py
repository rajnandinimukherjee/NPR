...
stat_only_values = {
        f'RISMOM_2GeV_{scheme}': {key:fit_systematics['central'][key][0]
                        for key in quantities},
        f'RISMOM_3GeV_{scheme}': {key:scaling_systematics['(2,3)'][key]
                        for key in quantities},
        f'MSbar_3GeV_{scheme}': {key:MS_bar_results[scheme][key]['central']
                                 for key in quantities}
        }
...
filename = f'/Users/rajnandinimukherjee/Desktop/draft_plots/correlation_data/correlations.h5'
