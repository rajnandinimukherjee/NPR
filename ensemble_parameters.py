...
params = {'C0': {'XX': 48,
          ...
          'C1': {'XX': 24,
                 ...
                 'Lss': [16, 12],
                 'M5s': [1.8, 1.0],
                 'masses': [0.005, 0.01, 0.02, 0.04, 0.05, 0.1, 0.15, 0.2,   0.3,   0.4,   0.5, 0.33],
          ...
          'M1M': {'XX':32,
                  ...
                  'Lss'        :[12      ,12       ],
                  'M5s'        :[1.8     ,1.0      ],
                  'masses' :[0.004, 0.008, 0.0133, 0.02661, 0.05, 0.1, 0.15, 0.225,   0.3,   0.375,   0.45, 0.32, 0.34, 0.36],
                  'safe_masses':[0.004, 0.008, 0.0133, 0.02661, 0.05, 0.1, 0.15, 0.225, 0.3, 0.32, 0.34],
          ...
          'M1': {'XX': 32,
                 ...
                 'Lss': [16, 12],
                 'M5s': [1.8, 1.0],
                 'masses': [0.004, 0.008, 0.015, 0.03, 0.05, 0.1, 0.15,  0.225,   0.3, 0.375,   0.45, 0.32, 0.34, 0.36],
                  'safe_masses':[0.004, 0.008, 0.015, 0.03, 0.05, 0.1, 0.15, 0.225, 0.3, 0.32, 0.34, 0.36, 0.375],
          ...
          'F1M': {'XX': 48,
                  ...
                  'Lss': [12, 12],
                  'M5s': [1.8, 1.0],
                  'masses': [0.00214, 0.00428, 0.0107, 0.02144, 0.033, 0.066, 0.099, 0.132, 0.198, 0.264, 0.330, 0.396, 0.45, 0.36],
                  'safe_masses': [0.00214, 0.00428, 0.0107, 0.02144, 0.033, 0.066, 0.099, 0.132, 0.198, 0.264, 0.330, 0.36],
                  'NPR_cfgs': list(str(x) for x in range(250, 1500+1, 250)),#[:-1],
                  'valence_cfgs':list(str(x) for x in sorted(list(set(list(range(200, 400, 20))+\
                          list(range(400,1600+1,100)))))),#[:15],
          ...
          'F1S': {'XX': 48,
                  ...
                  'M5s': [1.8, 1.0],
                  'masses': [0.00214, 0.00428, 0.0107, 0.02144, 0.033, 0.066, 0.099, 0.132, 0.198, 0.264, 0.330, 0.396, 0.45, 0.36],
                  'safe_masses': [0.00214, 0.00428, 0.0107, 0.02144, 0.033, 0.066, 0.099, 0.132, 0.198, 0.264, 0.330, 0.396],
                  'NPR_cfgs': list(str(x) for x in range(4000, 7500+1, 500)),
                  'valence_cfgs':list(str(x) for x in sorted(list(set(list(range(4000, 7600+1, 400))+\
                          list(range(4240,7840+1,400)))))),#[9:],
                  'resids': [1.e-8, 1.e-10, 1.e-10, 1.e-12, 1.e-12, 1.e-12]},
          'KEKF1': {'XX': 64,
                    'TT': 128,
                    'Ls': 8,
