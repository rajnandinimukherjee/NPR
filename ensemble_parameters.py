...
params = {'C0': {'XX': 48,
          ...
          'C1M': {'XX': 24,
                  ...
                  'masses': [0.0025, 0.005, 0.01, 0.0181, 0.0362, 0.05, 0.1, 0.15, 0.2,   0.3,   0.4,   0.5],
          ...
          'C1': {'XX': 24,
                 ...
                 'Lss': [16, 12],
                 'M5s': [1.8, 1.0],
                 'masses': [0.005, 0.01, 0.02, 0.2,   0.3,   0.4,   0.5],
                 'resids': [1.e-8, 1.e-10, 1.e-10, 1.e-12, 1.e-12, 1.e-12]},
          'C2': {'XX': 24,
                 'TT': 64,
                 'Ls': 16,
          ...
          'M1M': {'XX':32,
                  ...
                  'Lss'        :[12      ,12       ],
                  'M5s'        :[1.8     ,1.0      ],
                  'masses' :[0.002, 0.004, 0.008, 0.0133, 0.02661, 0.05, 0.1, 0.15, 0.225,   0.3,   0.375,   0.45],
                  'resids' :[1.e-8, 1.e-8, 1.e-8, 1.e-8, 1.e-8, 1.e-8, 1.e-10, 1.e-10,1.e-10,1.e-12,1.e-12,1.e-12]},
          'M1': {'XX': 32,
                 'TT': 64,
                 'Ls': 16,
                 ...
                 'Lss': [16, 12],
                 'M5s': [1.8, 1.0],
                 'masses': [0.004, 0.008, 0.015, 0.15,   0.225,   0.3, 0.375,   0.45],
                 'resids': [1.e-8, 1.e-10, 1.e-10, 1.e-12, 1.e-12, 1.e-12,]},
          'M2': {'XX': 32,
                 'TT': 64,
                 'Ls': 16,
          ...
          'F1S': {'XX': 48,
                  ...
                  'Lss': [12, 12],
                  'M5s': [1.8, 1.0],
                  'masses': [0.02144, 0.132, 0.198, 0.264, 0.330, 0.396],
                  'resids': [1.e-8, 1.e-10, 1.e-10, 1.e-12, 1.e-12, 1.e-12]},
          'KEKF1': {'XX': 64,
                    'TT': 128,
                    'Ls': 8,
